...
class StudentBasicPage extends StatefulWidget{

  StudentBasicPage({Key key, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => new _StudentBasicPageState();
}

class _StudentBasicPageState extends State<StudentBasicPage>{
